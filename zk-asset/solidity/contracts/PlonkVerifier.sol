...
contract PlonkVerifier {
  ...
  uint256 private constant G2_SRS_1_X_0 = 11584023816568614163204900656409465042886204774939246875073944151967639210351;
  uint256 private constant G2_SRS_1_X_1 = 12956998273013011373428031683076976723929981497541709024246969319780595267277;
  uint256 private constant G2_SRS_1_Y_0 = 12295883637149567911206427372482045852772256712002254062236584406820869349603;
  uint256 private constant G2_SRS_1_Y_1 = 15219510369145024932498745720156533852353498688569369448909572795800614189584;
  
  uint256 private constant G1_SRS_X = 1;
  uint256 private constant G1_SRS_Y = 2;

  // ----------------------- vk ---------------------
  uint256 private constant VK_NB_PUBLIC_INPUTS = 4;
  uint256 private constant VK_DOMAIN_SIZE = 32768;
  uint256 private constant VK_INV_DOMAIN_SIZE = 21887574895677414892802367463831943750807625009412603678587617693528122466305;
  uint256 private constant VK_OMEGA = 20402931748843538985151001264530049874871572933694634836567070693966133783803;
  uint256 private constant VK_QL_COM_X = 7165739826548914592283865090063006134907692820681012326408151405432347762257;
  uint256 private constant VK_QL_COM_Y = 2802424183321864866995225397343075868665378646942174523003292180594409052600;
  uint256 private constant VK_QR_COM_X = 3404059698184410099596027322381614614243111490732959718738221787187123957801;
  uint256 private constant VK_QR_COM_Y = 17096363035202177105444861418966155328623849006246462482364017220281848633669;
  uint256 private constant VK_QM_COM_X = 18451362502324865640328127122039159310967143817771426412860093523964147549581;
  uint256 private constant VK_QM_COM_Y = 18539748270330782577467337352077440938763103042163957462846054213032521182644;
  uint256 private constant VK_QO_COM_X = 21269258287284981283390783413172710700797090644794676563763788074932534093849;
  uint256 private constant VK_QO_COM_Y = 5539646818233050295789905619120622702340193047040080287864162776702048740136;
  uint256 private constant VK_QK_COM_X = 11211022571885835075118335768868278997567604430175114625990176133791936090725;
  uint256 private constant VK_QK_COM_Y = 12152648951182817696321397914461437817139170267864414177378615740245790542855;
  
  uint256 private constant VK_S1_COM_X = 8598721728830985220173080879937313273706065257721578757261940442536448632684;
  uint256 private constant VK_S1_COM_Y = 12060731695847420100288251846010055236187270449056666850052139626288832688376;
  
  uint256 private constant VK_S2_COM_X = 16405092983071896173971343845609396989736437496225401842408233553469899757820;
  uint256 private constant VK_S2_COM_Y = 20487435829188932617809425693593311280901350825048377793918953765241799581908;
  
  uint256 private constant VK_S3_COM_X = 339555816680624425513882132210251890727001302867525195517125002360723887691;
  uint256 private constant VK_S3_COM_Y = 20881479004417933475768072893391009023752470248191977072579382668429316231472;
